...
#MAP URL
#######
if [ "$MAPURL" = "IronPort" ] then 
MAPURL="https://www.dropbox.com/s/601lt64f6kvmx6s/IronPortT2.map?dl=1"
else
echo "Error: Please select map"
exit
fi
